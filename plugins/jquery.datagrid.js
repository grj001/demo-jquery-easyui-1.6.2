...
(function ($) {
    ...
    function _59(_5a) {
        ...
        if (_5c.pagination) {
            ...
            _63.pagination({
                total: 0, pageNumber: _5c.pageNumber, pageSize: _5c.pageSize, pageList: _5c.pageList, onSelectPage: function (_65, _66) {
    ...
    function _76(_77) {
        ...
        _7d.each(function () {
            $(this).resizable({
                handles: _7e, edge: _7a.resizeEdge, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
                    _78.resizing = true;
    ...
    // endEdit 的方法(datagrid, editIndex, false)
    function _15b(_15c, _15d, _15e) {
        //获取datagrid 的 datagrid对象
